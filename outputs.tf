output "outputs" {
  value = [
    ...
    "Hostname: ${digitalocean_droplet.evilginx2.name}     - IP: ${digitalocean_droplet.evilginx2.ipv4_address}",
    ...
    "3. SSH into ${digitalocean_droplet.evilginx2.name} and set up your evilginx2 server."
  ]
}
