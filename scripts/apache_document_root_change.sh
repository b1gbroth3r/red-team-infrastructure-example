...
sed -i 's/\/var\/www\/html/\/var\/www\/html\/SETUP_WEBROOT_DIR/g' /etc/apache2/sites-enabled/000-default.conf # change document root to /var/www/html/domain/
sed -i 's/\/var\/www\/html/\/var\/www\/html\/SETUP_WEBROOT_DIR/g' /etc/apache2/sites-enabled/000-default-le-ssl.conf # same as previous line only for HTTPS site
